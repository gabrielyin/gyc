    ...
    <Form {...registerForm}>
      <form onSubmit={registerForm.handleSubmit(criarConta)} className="space-y-4">
        ...
        <div className="flex justify-between">
          <Button disabled={registerForm.formState.isSubmitting}>{registerForm.formState.isSubmitting ? <div className="space-x-2 flex"><Loader2Icon className="animate-spin" /> Criando...</div> : 'Criar conta'}</Button>
